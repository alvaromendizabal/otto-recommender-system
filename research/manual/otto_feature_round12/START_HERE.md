...
```bash
/opt/conda/bin/python -u "$HOME/otto_feature_round12/launch.py" bundle
```

Return `otto_feature_round12/otto_round12_return.zip`. Large source matrices, factors and models remain private in AWS; the return contains receipts, logs, metrics and notebooks. Do not upload it publicly.
...
```bash
/opt/conda/bin/python -u "$HOME/otto_feature_round12/launch.py" tests
/opt/conda/bin/python -u "$HOME/otto_feature_round12/launch.py" prepare
/opt/conda/bin/python -u "$HOME/otto_feature_round12/launch.py" representations
/opt/conda/bin/python -u "$HOME/otto_feature_round12/launch.py" features
/opt/conda/bin/python -u "$HOME/otto_feature_round12/launch.py" screen
/opt/conda/bin/python -u "$HOME/otto_feature_round12/launch.py" report
```

Success markers: ROUND12_TESTS_PASSED, ROUND12_REPRESENTATION_INPUTS_READY, ROUND12_REPRESENTATIONS_READY, ROUND12_FEATURES_READY, ROUND12_SCREEN_COMPLETED, ROUND12_REPORT_READY.
