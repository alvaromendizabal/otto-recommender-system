...
def collect():
    ...
    manifest=[];target=ROOT/'otto_round10_return.zip';tmp=target.with_suffix('.assembling')
...
if __name__=='__main__':
    if len(sys.argv)!=2:raise SystemExit('Usage: python launch.py tests|features|screen|report|bundle')
