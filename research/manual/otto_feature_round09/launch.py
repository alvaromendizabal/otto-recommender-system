...
CAPS={'tests':90,'features':260,'screen':260,'report':90}
...
def collect():
    ...
    manifest=[];target=ROOT/'otto_round09_return.zip';tmp=target.with_suffix('.assembling')
...
def _run_stage(phase):
    ...
    if phase not in ('report','bundle'):
        ...
        other=Path.home()/'otto_feature_round08/outputs/runs'
