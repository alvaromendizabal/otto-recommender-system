"""Show the learned-feature pilot and recent CloudWatch progress; never starts a job."""
...
def main() -> int:
    ...
    receipt = json.loads((root / "reports/research/representation_run.json").read_text())
